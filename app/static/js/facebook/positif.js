document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateTable(data) {
        if (data.status === 'success') {
            ...
            commentsArray.sort((a, b) => b.grade - a.grade);
            // Filter to only show positive sentiment
            const positiveComments = commentsArray.filter(comment => comment.sentimen === 'Positif');
            ...
            if (positiveComments.length > 0) {
                ...
                // Prepare top 5 positive comments for notification dropdown
                const positiveNotificationComments = commentsArray
                ...
                positiveNotificationComments.forEach(comment => {
                ...
                console.error('Error processing comments: Empty positiveComments array');
            }
        } else {
