document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateTable(data) {
        if (data.status === 'success') {
            ...
            tweetsArray.sort((a, b) => b.grade - a.grade);
            const positiveTweets = tweetsArray.filter(tweet => tweet.sentimen === 'Positif');
            ...
            if (positiveTweets.length > 0) {
                ...
                console.error('Error processing tweets: Empty positiveTweets array');
            }
        } else {
